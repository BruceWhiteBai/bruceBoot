...
public class UserTest extends WebApplicationTests {
    ...
    public void testHtmlMail(){
        javaMail.sendHtmlMail("1258444549@qq.com","哈喽","<h1>this mail from boot</h1>");
    ...
    public void sendAttachmentsMail(){
        ...
        javaMail.sendAttachmentsMail("1258444549@qq.com","哈喽","<h1>this mail from boot</h1>" ,new String[]{f1,f2});
