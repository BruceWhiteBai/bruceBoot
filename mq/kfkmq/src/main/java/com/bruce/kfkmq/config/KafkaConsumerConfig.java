...
package com.bruce.kfkmq.config;

import com.bruce.kfkmq.consumer.MyBatchListener;
import com.bruce.kfkmq.consumer.MyListener;
...
public class KafkaConsumerConfig {
    ...
    @Bean
    public MyListener listener0() {
        return new MyListener();
    }

    @Bean
    public MyBatchListener listener1() {
