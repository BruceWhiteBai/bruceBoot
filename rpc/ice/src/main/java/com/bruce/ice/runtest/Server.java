...
import com.bruce.ice.Demo._HelloPrxI;
...
public class Server {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ObjectAdapter adapter = ic.createObjectAdapterWithEndpoints("SimplePrinterAdapter", "default -p 1000");

            // 实例化一个PrinterI对象，为Printer接口创建一个servant
            System.out.println("为接口创建servant...");
            com.zeroc.Ice.Object object = new _HelloPrxI();
