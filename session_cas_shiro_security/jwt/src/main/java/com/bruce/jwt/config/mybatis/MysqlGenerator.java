...
public class MysqlGenerator {
    ...
    public static void Generator(String[] tableName) {
        ...
        gc.setOutputDir(projectPath + "/session_cas_shiro_security/jwt/src/main/java")
                .setActiveRecord(true)// 是否支持 AR
                .setAuthor("bruce") //设置作者名字
        ...
        pc.setParent("com.bruce.jwt")//配置父包路径
    ...
    public static void main(String[] args) {
        Generator(new String[]{"t_user", "tbl_employee"});
    }
}
